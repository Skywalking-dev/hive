---
name: vercel
description: Deploy, manage environment variables, view logs, and configure cron jobs with Vercel CLI. Use when deploying to Vercel, managing env vars, viewing logs, or configuring cron in vercel.json.
